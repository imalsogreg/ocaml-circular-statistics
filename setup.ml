...
(* OASIS_START *)
(* DO NOT EDIT (digest: 787135af4746d8b563449e25054d6226) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("optimization1d", None)
                        ];
                      bs_build_tools =
                        [
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "circstat";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "Example_plot.ml"; });
               Executable
                 ({
                     cs_name = "example_dist_samps";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "Example_dist_samps.ml";
                      })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\215\205\160\151\138\216\246\"S\179I-\011\221\228\167";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
